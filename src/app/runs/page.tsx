...
function RunsPageInner() {
  const t = useT({
    zh: {
      ...
      chipFailed: '失败',
      chipRunning: '进行中',
      scopeActive: '当前 Profile',
      scopeAll: '全部 Profile',
      subForProfile: (id: string) => `仅当前 profile · ${id}`,
      noMatch: '未匹配到任何运行',
    ...
    en: {
      ...
      subAcross: 'across every profile',
      ...
      chipFailed: 'Failed',
      chipRunning: 'Running',
      scopeActive: 'Active profile',
      scopeAll: 'All profiles',
      subForProfile: (id: string) => `active profile only · ${id}`,
