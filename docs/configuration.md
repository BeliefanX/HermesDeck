...
4. 确认 Hermes Agent API Server Agent catalog/models/cron endpoints 可用；Deck 不会在 outage 时本地枚举补齐。
5. 对 named Agents 配置独立 API base/port 与 API key，避免请求落到 default Agent。
